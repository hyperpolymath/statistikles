...
// Replace statistikles, Statistikles — See README.adoc for details., just run, Statistikles started successfully. with actuals
...
Statistikles — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./statistikles-portable
----
...
[source]
----
Statistikles started successfully.
----
