...
// Replace statistease, Statistease — See README.adoc for details., just run, Statistease started successfully. with actuals
= statistease — Quick Start for Users
:toc:
:toclevels: 2

== What is statistease?

Statistease — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./statistease-portable
----
...
[source]
----
Statistease started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/statistease/wiki
