...
Replace all {{PLACEHOLDER}} values with your information:
  ...
  https://github.com/hyperpolymath/statistease          - Your website/domain
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/statistease/security/advisories/new)
...
- This repository (`hyperpolymath/statistease`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/statistease/security/advisories)
...
When using StatistEase, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/statistease/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/statistease/security/advisories/new) or jonathan.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/statistease/discussions) |
...
*Thank you for helping keep StatistEase and its users safe.* 🛡️
