...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/statistikles/security/advisories/new)
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/statistikles/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/statistikles/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/statistikles/discussions) |
...
*Thank you for helping keep Statistikles and its users safe.* 🛡️
